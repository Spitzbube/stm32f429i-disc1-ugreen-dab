...
void BSP_SDRAM_Initialization_sequence(uint32_t RefreshCount)
{
  ...
  /* Send the command */
  HAL_SDRAM_SendCommand(&/*SdramHandle*/hsdram1, &Command, SDRAM_TIMEOUT);
  ...
  HAL_SDRAM_ProgramRefreshRate(&/*SdramHandle*/hsdram1, RefreshCount);
}
...
{
  if(HAL_SDRAM_Read_32b(&/*SdramHandle*/hsdram1, (uint32_t *)uwStartAddress, pData, uwDataSize) != HAL_OK)
  {
    return SDRAM_ERROR;
  }
  else
...
{
  if(HAL_SDRAM_Read_DMA(&/*SdramHandle*/hsdram1, (uint32_t *)uwStartAddress, pData, uwDataSize) != HAL_OK)
  {
    return SDRAM_ERROR;
  }
  else
...
uint8_t BSP_SDRAM_WriteData(uint32_t uwStartAddress, uint32_t *pData, uint32_t uwDataSize)
{
  ...
  HAL_SDRAM_WriteProtection_Disable(&/*SdramHandle*/hsdram1);

  /*Write 32-bit data buffer to SDRAM memory*/
  if(HAL_SDRAM_Write_32b(&/*SdramHandle*/hsdram1, (uint32_t *)uwStartAddress, pData, uwDataSize) != HAL_OK)
  {
    return SDRAM_ERROR;
  }
  else
...
{
  if(HAL_SDRAM_Write_DMA(&/*SdramHandle*/hsdram1, (uint32_t *)uwStartAddress, pData, uwDataSize) != HAL_OK)
  {
    return SDRAM_ERROR;
  }
  else
...
{
  if(HAL_SDRAM_SendCommand(&/*SdramHandle*/hsdram1, SdramCmd, SDRAM_TIMEOUT) != HAL_OK)
  {
    return SDRAM_ERROR;
  }
  else
